...
const { currentMonthKey, getGoalProgress } = require("../services/goal.service");
...
exports.getAnalytics = async (req, res, next) => {
  try {
    ...
    const goalProgress = await getGoalProgress(userId, currentMonthKey());
    const quality = await dataQualityService.getQualitySummary(userId, 30);
